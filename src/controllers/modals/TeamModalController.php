    ...
    return
      <div class="fb-modal-content">
        <div class="modal-title">
          <h4>{tr('team_')}[ <span class="team-name highlighted"></span> ]</h4>
        ...
        <div class="fb-column-container fb-modal-main">
          ...
          <div class="col col-1-4">
            <header><span class="highlighted">{tr('team_members')}</span></header>
        ...
        <footer class="modal-footer fb-column-container">
          <div class="col col-1-4">
            <header><span class="highlighted">{tr('base_pts')}</span></header>
            <div class="point-total points--base fb-numbers"></div>
          </div>
          <div class="col col-1-4">
            <header><span class="highlighted">{tr('quiz_pts')}</span></header>
            <div class="point-total points--quiz fb-numbers"></div>
          </div>
          <div class="col col-1-4">
            <header><span class="highlighted">{tr('flag_pts')}</span></header>
            <div class="point-total points--flag fb-numbers"></div>
          </div>
          <div class="col col-1-4">
            <header><span class="highlighted">{tr('total_pts')}</span></header>
